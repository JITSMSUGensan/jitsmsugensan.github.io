    ...
    return (
        <div className={`relative flex flex-col p-[20px] group cursor-pointer`}>
            ...
            <div className="flex flex-row justify-between items-center">
                <div className={`flex flex-row items-center space-x-[6px] transition-all group-hover:opacity-50`}>
...
export function News({ children, ...props }: { children: ReturnType<typeof NewsItem>[] | undefined, props?: any }) {
    return (
        <div className="space-y-[12px]">
            <p className="text-[30px] mt-[calc(36px-12px)]">LATEST NEWS</p>
            <div className="flex flex-col space-y-[20px] max-w-[1110px]">{children}</div>
        </div>
    );
}